...
@section('content')
    <div class="hero-wrap js-fullheight" style="background-image: url('images/voyage_international.jpg');">
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                ...
                <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Voyages
                        international</h1>
                </div>
            </div>
        </div>
